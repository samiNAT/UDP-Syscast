...
(4) open a new terminal and run the client $./client                                                                     *
 - after running both client and server you will start seeing your system information appear on the server screen        *
 - notice that you need to close the port if you run the server more than one time , use the command  $fuser -k 8021/udp *
**************************************************************************************************************************
enjoy!
